...
while(True):
    ...
    if circles is not None:        
        ...
        for i in circles[0,:]:
            ...
            cv2.circle(selecao_total,(i[0],i[1]),i[2],(0,255,0),2)
    ...
    cv2.putText(selecao_total,'dist={0:.2f} mm'.format(dist),(0,50), font, 0.5,(255,255,255),2,cv2.LINE_AA)
